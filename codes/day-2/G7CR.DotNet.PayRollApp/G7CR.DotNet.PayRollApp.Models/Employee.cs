namespace G7CR.DotNet.PayRollApp.Models
{
    public class Employee
    {
        ...
        public Employee(int id, string name, decimal basicPayment, decimal daPayment, decimal hraPyament)
        {
            this.id = id;
            this.name = name;
        ...
        public decimal HraPyament { get => hraPyament; set => hraPyament = value; }
        public decimal TotalPayment { get => totalPayment; }
        #endregion

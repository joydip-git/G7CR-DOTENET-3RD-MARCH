using HostingService.ApplicationExceptions;
using HostingService.DTOs;
using HostingService.Models;
...
namespace HostingService.DataAccessLayer
{
    public class ProductRepository : IRepository<ProductDTO, int>
    {
        ...
        private readonly IOptions<LoggerSettings> loggerOptions;

        public ProductRepository(ProductDbContext db, ILogger<ProductRepository> logger, IConfiguration configuration, IOptions<LoggerSettings> loggerOptions)
        {
        ...
        public IEnumerable<ProductDTO>? GetAll()
        {
            try
            {
                Console.WriteLine(configuration["loggerSettings:dbPath"]);

                logger.LogInformation("fetching all records");
